    ...
    <header className="header">
      <Fade>
        ...
        <ul className="hidden text-theme-red tracking-widest items-center lg:flex flex-row mt-0">
          ...
          <li>
            <Button
              className="text-lg mx-auto ml-3 px-6 py-2 bg-theme-red text-white rounded-full border-2 border-theme-red hover:bg-dark-theme-red border-red-800 transition duration-200"
              type="link"
