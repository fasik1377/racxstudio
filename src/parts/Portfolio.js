...
export default function Portfolio({ data }) {
  return (
    <section className="container mx-auto flex flex-col items-center mt-20">
      <Fade bottom>
        <h1 className="text-5xl text-theme-red text-center font-bold">Our Selected Project</h1>
      ...
      <Fade bottom>
        <Button href="/project" type="link" className="flex flex-grow-0 w-36 h-12 sm:w-40 sm:h-14 lg:w-44 lg:h-16 xl:w-36 xl:h-12 text-theme-red px-5 border border-theme-red items-center mt-14 rounded-full justify-center transition duration-300 hover:bg-theme-red hover:text-white">
